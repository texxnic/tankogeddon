...
void ATankAIController::BeginPlay()
{
	...
	GetWorld()->GetTimerManager().SetTimer(SwapCannonHandle, this, &ATankAIController::SwapCannon, ChangeCannonInterval, true);
}
void ATankAIController::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	Super::EndPlay(EndPlayReason);
	GetWorld()->GetTimerManager().ClearTimer(SwapCannonHandle);
}
...
void ATankAIController::SwapCannon()
{
	if(TankPawn)
	{
		TankPawn->SwapCannon();
